...
const updateMyShopController = async (req, res) => {
    ...
    return response_util_1.ResponseUtil.success(res, result.shop, "Cập nhật thông tin cửa hàng thành công");
};
...
const createMyShopProductController = async (req, res) => {
    ...
    return response_util_1.ResponseUtil.created(res, result.product, "Tạo sản phẩm mới cho cửa hàng thành công");
};
...
const updateMyShopProductController = async (req, res) => {
    ...
    return response_util_1.ResponseUtil.success(res, result.product, "Cập nhật sản phẩm cửa hàng thành công");
};
...
const deleteMyShopProductController = async (req, res) => {
    ...
    return response_util_1.ResponseUtil.success(res, result.product, "Xóa sản phẩm cửa hàng thành công");
};
...
const updateMyShopOrderStatusController = async (req, res) => {
    ...
    return response_util_1.ResponseUtil.success(res, result.order, "Cập nhật trạng thái đơn hàng cửa hàng thành công");
};
...
const getProductPortfolioAnalysisController = async (req, res) => {
    const query = req.query;
    const result = await shop_management_service_1.default.getProductPortfolioAnalysis(req, query);
    if (!result.ok) {
        return response_util_1.ResponseUtil.error(res, result.message, result.status);
    }
    return response_util_1.ResponseUtil.success(res, result.portfolio);
};
exports.getProductPortfolioAnalysisController = getProductPortfolioAnalysisController;
// 2. Customer Trend Compass
const getCustomerTrendCompassController = async (req, res) => {
    const query = req.query;
    const result = await shop_management_service_1.default.getCustomerTrendCompass(req, query);
    if (!result.ok) {
        return response_util_1.ResponseUtil.error(res, result.message, result.status);
    }
    return response_util_1.ResponseUtil.success(res, { trailData: result.trailData });
};
exports.getCustomerTrendCompassController = getCustomerTrendCompassController;
// 3. Order Forecast
const getOrderForecastController = async (req, res) => {
    const query = req.query;
    const result = await shop_management_service_1.default.getOrderForecast(req, query);
    if (!result.ok) {
        return response_util_1.ResponseUtil.error(res, result.message, result.status);
    }
    return response_util_1.ResponseUtil.success(res, { forecastData: result.forecastData });
};
exports.getOrderForecastController = getOrderForecastController;
// 4. Order Cancellation Analysis
const getOrderCancellationAnalysisController = async (req, res) => {
    const query = req.query;
    const result = await shop_management_service_1.default.getOrderCancellationAnalysis(req, query);
    if (!result.ok) {
        return response_util_1.ResponseUtil.error(res, result.message, result.status);
    }
    return response_util_1.ResponseUtil.success(res, { cancellationData: result.cancellationData });
};
exports.getOrderCancellationAnalysisController = getOrderCancellationAnalysisController;
// Lấy đánh giá shop
...
const batchPrintOrdersController = async (req, res) => {
    ...
    return response_util_1.ResponseUtil.success(res, result, "In hàng loạt đơn hàng thành công");
};
...
const addInternalNoteController = async (req, res) => {
    ...
    return response_util_1.ResponseUtil.success(res, result.note, "Thêm ghi chú nội bộ thành công");
};
...
const deleteInternalNoteController = async (req, res) => {
    ...
    return response_util_1.ResponseUtil.success(res, { message: result.message }, "Xóa ghi chú nội bộ thành công");
};
