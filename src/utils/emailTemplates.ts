...
export const getOtpEmailTemplateConfig = (
  purpose: string,
  payload: OtpTemplatePayload
    ...
    case "login_2fa":
      return {
        ...
        html: baseEmailLayout({
          ...
          subtitle:
            "Bạn đang đăng nhập vào tài khoản của mình. Vui lòng nhập mã OTP bên dưới để hoàn tất đăng nhập.",
    ...
    case "change_password":
      return {
        ...
        html: baseEmailLayout({
          ...
          subtitle:
            "Chúng tôi nhận được yêu cầu đổi mật khẩu từ bạn khi đang đăng nhập. Nhập mã OTP này để xác nhận.",
    ...
    case "verify_setting_change":
      return {
        ...
        html: baseEmailLayout({
          ...
          subtitle:
            "Bạn đang thay đổi cài đặt bảo mật (OTP/2 bước). Mã bên dưới giúp chúng tôi đảm bảo chính bạn thực hiện.",
    ...
    case "setup_smart_otp":
      return {
        ...
        html: baseEmailLayout({
          ...
          subtitle:
            "Nhập mã OTP để hoàn tất thiết lập Smart OTP cho tài khoản của bạn.",
    ...
    case "change_smart_otp_password":
      return {
        ...
        html: baseEmailLayout({
          ...
          subtitle:
            "Mã OTP bên dưới sẽ giúp bạn xác nhận việc đổi mật khẩu Smart OTP.",
          highlightLabel: "MÃ XÁC THỰC",
          highlightValue: payload.otpCode,
    ...
    case "forgot_password":
      return {
        ...
        html: baseEmailLayout({
          ...
          subtitle:
            "Sử dụng mã OTP bên dưới để đặt lại mật khẩu tài khoản của bạn.",
    ...
    default:
      return {
        ...
        html: baseEmailLayout({
          ...
          subtitle:
            "Mã OTP bên dưới giúp xác minh thao tác của bạn tại " + appName,
...
export const buildVerifyAccountEmail = ({
  userName,
  otpCode,
  appName = "SHOPONLINE",
}: {
  ...
  return {
    ...
    html: baseEmailLayout({
      ...
      subtitle:
        "Chúng tôi cần xác nhận email này thuộc về bạn. Nhập mã OTP bên dưới để kích hoạt tài khoản.",
...
export const buildTwoFactorRecommendationEmail = ({
  userName,
  appName = "SHOPONLINE",
}: {
  userName: string;
  ...
  return {
    ...
    html: baseEmailLayout({
      ...
      subtitle:
        "Bật xác minh 2 bước để nhận OTP mỗi khi đăng nhập. Điều này giúp tài khoản của bạn an toàn hơn trước các truy cập lạ.",
      note: "Truy cập mục Bảo mật trong tài khoản để kích hoạt ngay hôm nay.",
    }),
  };
};

export const buildTransactionConfirmationEmail = ({
  userName,
  orderCode,
  amount,
  actionUrl,
  ...
  const note =
    "Nếu bạn không thực hiện giao dịch này, vui lòng liên hệ đội ngũ CSKH của chúng tôi ngay.";
  return {
