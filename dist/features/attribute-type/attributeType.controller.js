...
exports.listAttributeTypesByCategoryController = exports.listAttributeTypeController = exports.deleteAttributeTypeController = exports.updateAttributeTypeController = exports.createAttributeTypeController = exports.getAttributeTypeController = void 0;
...
const listAttributeTypesByCategoryController = async (req, res) => {
    const { categoryId } = req.params;
    const result = await attributeType_service_1.default.listByCategory(categoryId);
    if (!result.ok)
        return response_util_1.ResponseUtil.error(res, result.message, result.status);
    return response_util_1.ResponseUtil.success(res, result.items);
};
exports.listAttributeTypesByCategoryController = listAttributeTypesByCategoryController;
